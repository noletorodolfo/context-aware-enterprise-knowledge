// Bundles the ingestion app into a self-contained deploy/ folder. Workspace packages (@kb/*) are symlinks
...
await writeFile(
  ...
  JSON.stringify({ name: "indexer-functions", version: "0.1.0", main: "main.cjs" }, null, 2),
);
